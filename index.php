...
<body>
    ...
    <nav class="navbar navbar-default">
        <span class="col-sm-12 btn-primary" style="height: 30px; padding-top: 5px;"><i class="fa-solid fa-envelope"></i>
            annisadwifebryanti@gmail.com &nbsp; <i class="fa-solid fa-phone"></i> 0812 3456 7890</span>
        <div class="container-fluid">
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="navbar-header">
                <a class="navbar-brand" href="#">KiTy</a>
            </div>
    ...
    <div class="jumbotron text-white jumbotron-image shadow" style="background-image: url(images/banner.jpg);">

        <div class="container py-5">
            <h2 class="mb-4">
                <strong>Selamat Datang di KiTy</strong>
            </h2>
            <p class="mb-4">
                Monitoring sistem informasi pendeteksi dan pengamanan kebocoran gas dan kebakaran
            </p>
            ...
            <a href="#" class="btn btn-primary" id="masuk">Masuk</a>
        </div>
    </div>
